...
"""
Original code is from PyTorch v1.2.0
...
class TransformerEncoder(nn.Module):
    ...
    def get_attention(self):
        """
        Get o_pred_prob = soft_attention
        * TODO: multi_head_attention --> average (currently)

        Returns
        -------
        o_pred_prob : torch.tensor
        """
        return self.layers[-1].get_attention()
...
class TransformerEncoderLayer(nn.Module):
    ...
    def get_attention(self):
        ...
        * TODO: multi_head_attention --> average (currently)
        ...
        o_pred_prob : torch.tensor
        """
        return self.attention_weight.clone()
    ...
    def forward(self, src, src_mask=None, src_key_padding_mask=None):
        ...
        Shape:
            see the docs in Transformer class.
        """
        src2, self.attention_weight = self.self_attn(
            src,
            src,
            src,
            attn_mask=src_mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask=None, memory_mask=None,
        ...
        tgt = tgt + self.dropout1(tgt2)  # addition
        tgt = self.norm1(tgt)
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
            self, embed_dim, num_heads, dropout=0., bias=True,
    ...
    Args:
        ...
        key_padding_mask: if provided, specified padding elements in the key
            ...
            When the value is True, the corresponding value on
    ...
    Shape:
        ...
        - value: :math:`(S, N, E)` where S is the source sequence length,
          N is the batch size, E is the embedding dimension.
        - key_padding_mask: :math:`(N, S)`, ByteTensor,
        ...
        """
        if hasattr(self, '_qkv_same_embed_dim') and \
           self._qkv_same_embed_dim is False:
            ...
            if not hasattr(self, '_qkv_same_embed_dim'):
                warnings.warn(
                    'A new version of MultiheadAttention module '
...
def multi_head_attention_forward(
    ...
    # NOTE: to avoid F821 error, double # # is used here (why ?)
    ...
    Args:
        ...
        bias_k, bias_v: bias of the key and value sequences to be added
        at dim=0.
        add_zero_attn: add a new batch of zeros to the key and
                       value sequences at dim=1.
